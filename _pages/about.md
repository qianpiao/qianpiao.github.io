...
<div style="text-align: justify; text-indent: -1.5em;">
  <ul style="list-style-position: inside;">
    ...
    <li><span style="font-size:16px"><strong>Qianpiao Ma</strong>, Junlong Zhou, Jianchun Liu, Hongli Xu, Jianeng Miao, Qingmin Jia, “Air-FedGA: A Grouping Asynchronous Federated Learning Mechanism Exploiting Over-the-air Computation”, <strong><em> IEEE International Parallel and Distributed Processing Symposium (IPDPS)</em></strong>, 2025. (<span style="color:green"><strong>CCF-B</strong></span>)</span></li>
