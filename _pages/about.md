...
<div style="text-align: justify; text-indent: -1.5em;">
  <ul style="list-style-position: inside;">
    ...
    <li><span style="font-size:16px">Luyao Gao, Jianchun Liu, Hongli Xu, Sun Xu, <strong>Qianpiao Ma</strong>, Liusheng Huang, “Accelerating End-Cloud Collaborative Inference via Near Bubble-free Pipeline Optimization”, <strong><em>IEEE Conference on Computer Communications (INFOCOM)</em></strong>, 2025. (<span style="color:green"><strong>CCF-A</strong></span>)
